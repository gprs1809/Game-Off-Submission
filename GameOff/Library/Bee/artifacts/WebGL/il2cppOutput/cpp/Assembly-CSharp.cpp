...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Start_m1D83076E8B136A71051F2F02545EE04947D3A8CF (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_6 = __this->___dirtParticles;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Update_m1F4051EB5BCBCCE5EEE2E3E49B7E278C3B14EC33 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		int32_t L_8 = __this->___scoreVal;
		__this->___scoreVal = ((int32_t)il2cpp_codegen_add(L_8, 1));
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_9 = __this->___scoreText;
		int32_t* L_10 = (int32_t*)(&__this->___scoreVal);
		String_t* L_11;
		...
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_14 = __this->___jumpSound;
		AudioSource_PlayOneShot_mF6FE95C58996B38EF6E7F7482F95F5E15E0AB30B(L_13, L_14, (1.0f), NULL);
		__this->___onGround = (bool)0;
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_15 = __this->___playerAnim;
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_15, _stringLiteral1625B4B9C4A74413B07D2018D406E68C6755A804, NULL);
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_16 = __this->___dirtParticles;
...
IL_0025:
	...
	}
	{
		...
		AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299* L_13 = __this->___playerAudio;
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_14 = __this->___crashSound;
		AudioSource_PlayOneShot_mF6FE95C58996B38EF6E7F7482F95F5E15E0AB30B(L_13, L_14, (1.0f), NULL);
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_15 = __this->___explosionParticle;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RepeatBackground_Start_mBC99B8939FC946126F5193638EB14ED609C83444 (RepeatBackground_t24ABC10CBE0AFE082D23DFF014D0128CD52FF46F* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_4 = L_3.___x;
		__this->___repeatWidth = ((float)(L_4/(1.79999995f)));
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnManager_Start_m65C9EA67649948222CFF4FBBF77BE2319D813DAF (SpawnManager_tD38605BF221D4CC849CF709A85499D2B698FD6FC* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_3 = __this->___intervalTime;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnManager_SpawnObstacle_mE5D7865D1E72DF72FAB39ACE07DA8AF8E81B4F42 (SpawnManager_tD38605BF221D4CC849CF709A85499D2B698FD6FC* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		int32_t L_4;
		L_4 = Random_Range_m6763D9767F033357F88B6637F048F4ACA4123B68(1, 3, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_5;
		memset((&L_5), 0, sizeof(L_5));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_5), (1.0f), ((float)L_4), (1.0f), NULL);
		Transform_set_localScale_mBA79E811BAF6C47B80FF76414C12B47B3CD03633(L_3, L_5, NULL);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_6 = __this->___obstaclePrefab;
...
{
	{
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_0), (8.0f), (-9.5f), (3.0f), NULL);
		__this->___spawnPos = L_0;
		__this->___startTime = (2.0f);
		__this->___intervalTime = (2.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
